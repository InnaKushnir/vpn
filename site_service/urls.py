...
urlpatterns = [
    ...
    path('stats/user/<int:id>/', views.UserSiteStats.as_view(), name='stats-user'),
    path('proxy/<str:user_site_name>/', views.proxy_view, name='proxy-view'),
    path('proxy/<str:user_site_name>/<path:routes_on_original_site>/',
         views.proxy_view_with_path, name='proxy-view-with-path'),
]
